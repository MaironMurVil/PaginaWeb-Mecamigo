<nav class="navbar navbar-expand-lg navbar-light container">
      ...
      <a class="navbar-brand" href="../../index.php">
        <img src="../shared/img/fg2.png" class="fg">
      </a>
      ...
      <div class="collapse navbar-collapse">
        <div class="input-group mb-3">
          ...
          <div class="input-group-append">
            <button class="btn btn-light" type="button"><img src="../shared/img/lupa.png"></button>
          </div>
        </div> 
      </div>

      <!--diamante-->
      <img src="../shared/img/coin.png" class="icono"><p>199</p>

      <!-- Perfil -->
      <img src="../shared/img/perfil.gif" class="icono"><p>Gorshito</p>      
</nav>
    <!-- Menú -->
